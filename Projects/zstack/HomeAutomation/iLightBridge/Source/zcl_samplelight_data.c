...
#define ILIGHTBRIDGE_DEVICE_VERSION     0
#define ILIGHTBRIDGE_FLAGS              0

#define ILIGHTBRIDGE_HWVERSION          1
#define ILIGHTBRIDGE_ZCLVERSION         1
...
// Basic Cluster
const uint8 iLightBridge_HWRevision = ILIGHTBRIDGE_HWVERSION;
const uint8 iLightBridge_ZCLVersion = ILIGHTBRIDGE_ZCLVERSION;
const uint8 iLightBridge_ManufacturerName[] = { 16, 'T','e','x','a','s','I','n','s','t','r','u','m','e','n','t','s' };
const uint8 iLightBridge_ModelId[] = { 16, 'T','I','0','0','0','1',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 iLightBridge_DateCode[] = { 16, '2','0','0','6','0','8','3','1',' ',' ',' ',' ',' ',' ',' ',' ' };
const uint8 iLightBridge_PowerSource = POWER_SOURCE_MAINS_1_PHASE;

uint8 iLightBridge_LocationDescription[17] = { 16, ' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ' };
uint8 iLightBridge_PhysicalEnvironment = 0;
uint8 iLightBridge_DeviceEnable = DEVICE_ENABLED;

// Identify Cluster
uint16 iLightBridge_IdentifyTime = 0;
#ifdef ZCL_EZMODE
uint8  iLightBridge_IdentifyCommissionState;
#endif

// On/Off Cluster
uint8  iLightBridge_OnOff = LIGHT_OFF;

// Level Control Cluster
#ifdef ZCL_LEVEL_CTRL
uint8  iLightBridge_LevelCurrentLevel = ATTR_LEVEL_MIN_LEVEL;
uint16 iLightBridge_LevelRemainingTime;
uint16 iLightBridge_LevelOnOffTransitionTime = 20;
uint8  iLightBridge_LevelOnLevel = ATTR_LEVEL_MID_LEVEL;
uint16 iLightBridge_LevelOnTransitionTime = 20;
uint16 iLightBridge_LevelOffTransitionTime = 20;
uint8  iLightBridge_LevelDefaultMoveRate = 0;   // as fast as possible
#endif

#if ZCL_DISCOVER
CONST zclCommandRec_t iLightBridge_Cmds[] =
{
  {
...
CONST uint8 zclCmdsArraySize = ( sizeof(iLightBridge_Cmds) / sizeof(iLightBridge_Cmds[0]) );
#endif // ZCL_DISCOVER

/*********************************************************************
 * ATTRIBUTE DEFINITIONS - Uses REAL cluster IDs
 */
CONST zclAttrRec_t iLightBridge_Attrs[] =
{
  // *** General Basic Cluster Attributes ***
  {
    ...
    {  // Attribute record
      ...
      (void *)&iLightBridge_HWRevision  // Pointer to attribute variable
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_BASIC,
  ...
  },
  {
    ...
    { // Attribute record
      ...
      ACCESS_CONTROL_READ,
      (void *)iLightBridge_ManufacturerName
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_BASIC,
  ...
  },
  {
    ...
    { // Attribute record
      ...
      (void *)iLightBridge_LocationDescription
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_BASIC,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT8,
      (ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE),
      (void *)&iLightBridge_PhysicalEnvironment
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_BASIC,
    { // Attribute record
      ...
      (ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE),
      (void *)&iLightBridge_DeviceEnable
    }
  },
  ...
  // *** Identify Cluster Attribute ***
  {
    ...
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      (ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE),
      (void *)&iLightBridge_IdentifyTime
    }
  },
 #ifdef ZCL_EZMODE
  // *** Identify Cluster Attribute ***
  {
    ...
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT8,
      (ACCESS_CONTROL_READ),
      (void *)&iLightBridge_IdentifyCommissionState
    }
  },
 #endif // ZCL_EZMODE
#endif
  ...
  , {
    ...
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT8,
      ACCESS_CONTROL_READ,
      (void *)&iLightBridge_LevelCurrentLevel
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ,
      (void *)&iLightBridge_LevelRemainingTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&iLightBridge_LevelOnOffTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT8,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&iLightBridge_LevelOnLevel
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&iLightBridge_LevelOnTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT16,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&iLightBridge_LevelOffTransitionTime
    }
  },
  {
    ZCL_CLUSTER_ID_GEN_LEVEL_CONTROL,
    { // Attribute record
      ...
      ZCL_DATATYPE_UINT8,
      ACCESS_CONTROL_READ | ACCESS_CONTROL_WRITE,
      (void *)&iLightBridge_LevelDefaultMoveRate
    }
  }
#endif
...
uint8 CONST iLightBridge_NumAttributes = ( sizeof(iLightBridge_Attrs) / sizeof(iLightBridge_Attrs[0]) );
...
#ifdef ZCL_LEVEL_CTRL
 #define iLightBridge_MAX_INCLUSTERS   6
#else
 #define iLightBridge_MAX_INCLUSTERS   5
#endif
...
#define iLightBridge_MAX_OUTCLUSTERS  (sizeof(iLightBridge_OutClusterList) / sizeof(iLightBridge_OutClusterList[0]))

SimpleDescriptionFormat_t iLightBridge_SimpleDesc =
{
  ILIGHTBRIDGE_ENDPOINT,                  //  int Endpoint;
